...
#nullable enable
        ...
        /// <returns></returns>
        public Task<List<Album>> GetAlbumsAsync(int pageSize = defaultPageSizeAlbums, bool excludeNonAppCreatedData = false, CancellationToken cancellationToken = default)
        {
...
#pragma warning disable CS8620 // Argument cannot be used for parameter due to differences in the nullability of reference types.
            var url = QueryHelpers.AddQueryString(uri, queryString: queryParams);
#pragma warning restore CS8620 // Argument cannot be used for parameter due to differences in the nullability of reference types.
        ...
        #endregion https://photoslibrary.googleapis.com/v1/albums
        ...
        //todo: add IPagable interface and merge with similar
        private async Task<List<MediaItem>> _GetMediaItemsAsync(int pageSize, int maxPageCount, bool excludeNonAppCreatedData, string requestUri, CancellationToken cancellationToken)
        {
        ...
        //todo: add IPagable interface and merge with similar
        private async Task<List<MediaItem>> _GetMediaItemsViaPOSTAsync(string? albumId, int pageSize, int maxPageCount, Filter? filters, bool excludeNonAppCreatedData, string requestUri, CancellationToken cancellationToken)
        {
            if (pageSize < minPageSizeMediaItems || pageSize > maxPageSizeMediaItems)
                throw new ArgumentOutOfRangeException($"{nameof(pageSize)} must be between {minPageSizeMediaItems} and {maxPageSizeMediaItems}!");
        ...
        private Task<List<MediaItem>> _GetMediaItemsByFilterAsync(Filter filter, int maxPageCount, CancellationToken cancellationToken)
        {
        ...
        #endregion https://photoslibrary.googleapis.com/v1/mediaItems
