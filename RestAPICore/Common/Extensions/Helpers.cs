...
#pragma warning restore CS8632 // The annotation for nullable reference types should only be used in code within a '#nullable' annotations context.
        ...
        #endregion IsNullOrEmpty & IsNullOrWhiteSpace cannot interpret nullable reference types correctly, needs more research
        ...
        private static Dictionary<string, object> dEnumLookup { get; set; } = new();
...
#nullable enable
        ...
        { get { return new Regex(cleanPattern, RegexOptions.Compiled); } }
        ...
        private static Regex rgxEmail
        { get { return new Regex(emailPattern, RegexOptions.Compiled); } }
